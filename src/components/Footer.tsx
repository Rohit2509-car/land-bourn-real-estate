...
import { Compass, ShieldCheck, Mail, ArrowRight, Phone, MapPin, Globe } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-xs sm:text-sm text-zinc-500 leading-relaxed">
              Aura Lands is an elite, double-authenticated escrow land registry platform. We bridge the gap between premium raw land investments and secure digital title closure under Swiss-level confidentiality protocols.
            </p>
            ...
            <div className="space-y-2 text-xs font-mono text-zinc-400">
              <div className="flex items-center space-x-2.5">
                ...
                <span>Bahnhofstrasse 104, 8001 Zürich, Switzerland</span>
              </div>
              <div className="flex items-center space-x-2.5">
                <Phone className="h-4 w-4 text-[#E53935]" />
                <span>+41 (44) 221-AURA (2872)</span>
              </div>
              <div className="flex items-center space-x-2.5">
                <Globe className="h-4 w-4 text-[#E53935]" />
                <span>escrow-desk@auralands.com</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            {success ? (
              <div className="rounded border border-green-600/20 bg-green-500/5 p-4 text-xs text-green-600 font-semibold flex items-center space-x-2">
                ...
                <span>Email credentials encrypted. Welcome to Aura Vault.</span>
              </div>
            ) : (
        ...
        <div className="pt-8 border-t border-zinc-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] font-mono">
          ...
          <div className="text-center sm:text-left">
            <span>© {currentYear} Aura Lands AG. Licensed broker network. Swiss legal registry #CH-020.3.104.928-1. All rights reserved.</span>
          </div>
